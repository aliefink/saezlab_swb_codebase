...
function definedRoutineBegin(snapshot) {
  return async function () {
    ...
    definedComponents.forEach( function(thisComponent) {
...
function HowHappyCheckLoopBegin(HowHappyCheckLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    HowHappyCheck.forEach(function() {
...
function SetupGraphicsRoutineBegin(snapshot) {
  return async function () {
    ...
    SetupGraphicsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function CalculateRoutineBegin(snapshot) {
  return async function () {
    ...
    CalculateComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function SelectionShownRoutineBegin(snapshot) {
  return async function () {
    ...
    SelectionShownComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function GambleRevealedRoutineBegin(snapshot) {
  return async function () {
    ...
    GambleRevealedComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function HowHappyRoutineBegin(snapshot) {
  return async function () {
    ...
    HowHappyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
