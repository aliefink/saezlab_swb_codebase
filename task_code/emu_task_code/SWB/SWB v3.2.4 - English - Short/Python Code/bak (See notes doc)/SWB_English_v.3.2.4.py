...
#Core elements
mywin= visual.Window(monitor="testMonitor",units="deg",fullscr=False,size=[1920,1080],color='white')
...
rScale=[Ratings,cArrow,happy,sad,rprompt,happytxt,unhappytxt]
baseScale=[Ratings,cArrow,happy,sad,baseratingprompt,happytxt,unhappytxt]
